...
Holmes had driven it back with his cane, and it had turned on its master. Justice, in this case, had been swift and fitting.`,
  },
  {
    ...
    author: "O. Henry",
    genre: "romance",
    themes: ["love", "friendship", "redemption"],
...
She was taken to the palace, and they were married. And so they had to live out their days as punishment for their deceit, while the girl — now a princess — lived with grace and joy for the rest of her days.`,
  },
  {
...
Madame Forestier stopped short. "Oh, my poor Mathilde. Mine was paste. Worth at most five hundred francs."`,
  },
  {
    ...
    genre: "fairy_tale",
    themes: ["love", "courage", "redemption"],
...
He tried again. His fingers were numb. He could barely grip the matches. He managed to light a clump, but could not separate them, and burned his hands. The fire caught and he put his hands out to warm them — too quickly. He put his hands out once more. The flame went out.
...
export function selectStory(interests: string[], themes: string[]): DemoStory {
  const scored = DEMO_STORIES.map((story) => {
    let score = 0
